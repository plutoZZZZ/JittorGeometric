...
MODEL_DATASETS = {
    'GCN': ['Cora', 'Citeseer', 'Pubmed', 'Computers', 'Photo', 'Chameleon', 'Squirrel', 'Reddit'],
    'GAT': ['Cora', 'Citeseer', 'Pubmed'],
    'GraphSAGE': ['Cora', 'Citeseer', 'Pubmed', 'Computers', 'Photo', 'Chameleon', 'Squirrel', 'Reddit'],
    'ChebNet2': ['Cora', 'Citeseer', 'Pubmed', 'Computers', 'Photo', 'Chameleon', 'Squirrel'],
    'SGC': ['Cora', 'Citeseer', 'Pubmed'],
    'APPNP': ['Cora', 'Citeseer', 'Pubmed', 'Computers', 'Photo', 'Chameleon', 'Squirrel'],
    'GPRGNN': ['Cora', 'Citeseer', 'Pubmed', 'Computers', 'Photo', 'Chameleon', 'Squirrel'],
    'BernNet': ['Cora', 'Citeseer', 'Pubmed', 'Computers', 'Photo', 'Chameleon', 'Squirrel'],
    'GCN2': ['Cora', 'Citeseer', 'Pubmed'],
    'EvenNet': ['Cora', 'Citeseer', 'Pubmed', 'Computers', 'Photo', 'Chameleon', 'Squirrel', 'Reddit'],
    'ChebConv': ['Cora', 'Citeseer', 'Pubmed'],
    'OptBasisGNN': ['Cora', 'Citeseer', 'Pubmed', 'Computers', 'Photo', 'Chameleon', 'Squirrel', 'Reddit'],
}
...
MODEL_PARAMS = {
    ...
    'GCN2': [
        {'key': 'hidden_dim', 'label': '隐藏层维度', 'type': 'number', 'default': 64},
        {'key': 'num_layers', 'label': 'GCN2层数', 'type': 'number', 'default': 64},
        {'key': 'alpha', 'label': '残差连接α', 'type': 'number', 'default': 0.1, 'step': 0.01},
        {'key': 'lambda', 'label': '平滑系数λ', 'type': 'number', 'default': 0.5, 'step': 0.1},
        {'key': 'dropout', 'label': 'Dropout率', 'type': 'number', 'default': 0.6, 'step': 0.1},
        {'key': 'lr', 'label': '学习率', 'type': 'number', 'default': 0.01, 'step': 0.001},
    ],
    'EvenNet': [
        {'key': 'hidden_dim', 'label': '隐藏层维度', 'type': 'number', 'default': 64},
        {'key': 'K', 'label': 'EvenNet传播阶数K', 'type': 'number', 'default': 10},
        {'key': 'alpha', 'label': 'PPR传送概率α', 'type': 'number', 'default': 0.2, 'step': 0.01},
        {'key': 'dropout', 'label': 'Dropout率', 'type': 'number', 'default': 0.5, 'step': 0.1},
        {'key': 'lr', 'label': '学习率', 'type': 'number', 'default': 0.01, 'step': 0.001},
    ],
    'ChebConv': [
        {'key': 'hidden_dim', 'label': '隐藏层维度', 'type': 'number', 'default': 64},
        {'key': 'K', 'label': 'Chebyshev阶数K', 'type': 'number', 'default': 2},
        {'key': 'dropout', 'label': 'Dropout率', 'type': 'number', 'default': 0.5, 'step': 0.1},
        {'key': 'lr', 'label': '学习率', 'type': 'number', 'default': 0.01, 'step': 0.001},
    ],
    'OptBasisGNN': [
        {'key': 'hidden_dim', 'label': '隐藏层维度', 'type': 'number', 'default': 64},
        {'key': 'K', 'label': 'OptBasis传播阶数K', 'type': 'number', 'default': 10},
        {'key': 'dropout', 'label': 'Dropout率', 'type': 'number', 'default': 0.5, 'step': 0.1},
        {'key': 'lr', 'label': '学习率', 'type': 'number', 'default': 0.01, 'step': 0.001},
    ],
}
...
MODEL_GRAPH_INFO = {
    ...
    'GCN2': {
        'nodes': [
            {'id': 'input', 'label': 'Input\nx: Var[N, F]', 'category': 'io'},
            {'id': 'linear0', 'label': 'Linear0\nnn.Linear(F, H)', 'category': 'meta'},
            {'id': 'relu0', 'label': 'ReLU\nnn.relu', 'category': 'meta'},
            {'id': 'dropout0', 'label': 'Dropout\nnn.dropout', 'category': 'meta'},
            {'id': 'gcn2conv1', 'label': 'GCN2Conv1\nα·x + β·x₀', 'category': 'custom'},
            {'id': 'relu1', 'label': 'ReLU\nnn.relu', 'category': 'meta'},
            {'id': 'dropout1', 'label': 'Dropout\nnn.dropout', 'category': 'meta'},
            {'id': 'gcn2conv2', 'label': 'GCN2Conv2\nα·x + β·x₀', 'category': 'custom'},
            {'id': 'relu2', 'label': 'ReLU\nnn.relu', 'category': 'meta'},
            {'id': 'dropout2', 'label': 'Dropout\nnn.dropout', 'category': 'meta'},
            {'id': 'linear_out', 'label': 'LinearOut\nnn.Linear(H, C)', 'category': 'meta'},
            {'id': 'logsoftmax', 'label': 'LogSoftmax\nnn.logsoftmax', 'category': 'meta'},
            {'id': 'output', 'label': 'Output\nVar[N, C]', 'category': 'io'},
        ],
        'edges': [
            ['input', 'linear0'], ['linear0', 'relu0'], ['relu0', 'dropout0'],
            ['dropout0', 'gcn2conv1'], ['gcn2conv1', 'relu1'], ['relu1', 'dropout1'],
            ['dropout1', 'gcn2conv2'], ['gcn2conv2', 'relu2'], ['relu2', 'dropout2'],
            ['dropout2', 'linear_out'], ['linear_out', 'logsoftmax'], ['logsoftmax', 'output'],
        ],
        'fusion_groups': [
            {
                'name': '元算子融合',
    ...
    'EvenNet': {
        'nodes': [
            ...
            {'id': 'dropout1', 'label': 'Dropout\nnn.dropout', 'category': 'meta'},
            {'id': 'linear2', 'label': 'Linear2\nnn.Linear(H, C)', 'category': 'meta'},
            {'id': 'scatter0', 'label': 'ScatterToEdge0\nscatter_to_edge', 'category': 'custom'},
            {'id': 'aggregate0', 'label': 'Aggregate0\nEvenNetProp', 'category': 'custom'},
            {'id': 'scatter2', 'label': 'ScatterToEdge2\nscatter_to_edge', 'category': 'custom'},
            {'id': 'aggregate2', 'label': 'Aggregate2\nEvenNetProp', 'category': 'custom'},
            {'id': 'even_combine', 'label': 'EvenCombine\nα^k·x_k', 'category': 'custom'},
            {'id': 'logsoftmax', 'label': 'LogSoftmax\nnn.logsoftmax', 'category': 'meta'},
            {'id': 'output', 'label': 'Output\nVar[N, C]', 'category': 'io'},
        ],
        'edges': [
            ['input', 'dropout0'], ['dropout0', 'linear1'], ['linear1', 'relu1'],
            ['relu1', 'dropout1'], ['dropout1', 'linear2'],
            ['linear2', 'scatter0'], ['scatter0', 'aggregate0'],
            ['linear2', 'scatter2'], ['scatter2', 'aggregate2'],
            ['aggregate0', 'even_combine'], ['aggregate2', 'even_combine'],
            ['even_combine', 'logsoftmax'], ['logsoftmax', 'output'],
        ],
        'fusion_groups': [
            {
                'name': '元算子融合',
            ...
            {
                'name': '跨边界融合',
                'ops': ['Aggregate0', 'EvenCombine'],
                'type': 'cross_boundary',
            },
            {
                'name': '跨边界融合',
                'ops': ['EvenCombine', 'LogSoftmax'],
                'type': 'cross_boundary',
            },
        ],
    },
    'ChebConv': {
        'nodes': [
            {'id': 'input', 'label': 'Input\nx: Var[N, F]', 'category': 'io'},
            {'id': 'chebconv1', 'label': 'ChebConv1\nChebyshev(K)', 'category': 'custom'},
            {'id': 'relu1', 'label': 'ReLU\nnn.relu', 'category': 'meta'},
            {'id': 'dropout1', 'label': 'Dropout\nnn.dropout', 'category': 'meta'},
            {'id': 'chebconv2', 'label': 'ChebConv2\nChebyshev(K)', 'category': 'custom'},
            {'id': 'logsoftmax', 'label': 'LogSoftmax\nnn.logsoftmax', 'category': 'meta'},
            {'id': 'output', 'label': 'Output\nVar[N, C]', 'category': 'io'},
        ],
        'edges': [
            ['input', 'chebconv1'], ['chebconv1', 'relu1'], ['relu1', 'dropout1'],
            ['dropout1', 'chebconv2'], ['chebconv2', 'logsoftmax'], ['logsoftmax', 'output'],
        ],
        'fusion_groups': [
            {
                'name': '跨边界融合',
    ...
    'OptBasisGNN': {
        'nodes': [
            ...
            {'id': 'relu1', 'label': 'ReLU\nnn.relu', 'category': 'meta'},
            {'id': 'dropout1', 'label': 'Dropout\nnn.dropout', 'category': 'meta'},
            {'id': 'optbasis', 'label': 'OptBasisConv\nOptBasis(K)', 'category': 'custom'},
            {'id': 'dropout2', 'label': 'Dropout\nnn.dropout', 'category': 'meta'},
            {'id': 'linear2', 'label': 'Linear2\nnn.Linear(H, C)', 'category': 'meta'},
            {'id': 'logsoftmax', 'label': 'LogSoftmax\nnn.logsoftmax', 'category': 'meta'},
            {'id': 'output', 'label': 'Output\nVar[N, C]', 'category': 'io'},
        ...
        'edges': [
            ['input', 'dropout0'], ['dropout0', 'linear1'], ['linear1', 'relu1'],
            ['relu1', 'dropout1'], ['dropout1', 'optbasis'],
            ['optbasis', 'dropout2'], ['dropout2', 'linear2'],
            ['linear2', 'logsoftmax'], ['logsoftmax', 'output'],
        ],
        'fusion_groups': [
            {
                'name': '元算子融合',
