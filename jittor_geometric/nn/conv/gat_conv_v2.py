...
class GATConvV2(MessagePassingNts):
    r"""The graph convolutional operator from the `"Graph Attention Networks v2" <https://arxiv.org/abs/2105.14491>`_ paper.
    
    The key difference from GAT v1 is the order of operations:
    - GAT v1: Linear combination -> Activation function
    - GAT v2: Activation function first, then multiply with attention vector
    """
